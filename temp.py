...
from maskrcnn_benchmark.engine.temp import temp_func
...
def main():
    ...
    data_loaders_test = make_data_loader(cfg, is_train=False, is_distributed=distributed, is_inference=False)
