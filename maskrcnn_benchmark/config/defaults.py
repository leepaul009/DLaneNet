...
# Type1: [down_line(near) num_up_pts] [up_line(far)]
# Type1: [down_line(near)] [num_up_pts up_line(far)]
_C.MODEL.HEAD_TYPE = 1
...
_C.INPUT.INPUT_IMAGE_SIZE = (256, 512)
_C.INPUT.ORIGINAL_IMAGE_SIZE = (1280, 720)

# Annotation
_C.INPUT.ANNOTATION = CN()
_C.INPUT.ANNOTATION.NUM_CLASS = 2
_C.INPUT.ANNOTATION.POINTS_PER_LANE = 80
_C.INPUT.ANNOTATION.ANCHOR_STRIDE = 16
# Instance
_C.INPUT.ANNOTATION.FEATURE_SIZE = 4
...
_C.DATALOADER.WEIGHTED_SAMPLE = False
_C.DATALOADER.WEIGHTED_SAMPLE_INPUT = ""
...
# ---------------------------------------------------------------------------- #
# Grid Fusion Net options
# ---------------------------------------------------------------------------- #
_C.MODEL.GFN = CN()
_C.MODEL.GFN.INTERNAL_CHANNEL = 64

# ---------------------------------------------------------------------------- #
# Grid Fusion Head options
# ---------------------------------------------------------------------------- #
_C.MODEL.GFH = CN()
_C.MODEL.GFH.INTERNAL_CHANNEL = 64

# ---------------------------------------------------------------------------- #
# Grid Instance Head options
# ---------------------------------------------------------------------------- #
_C.MODEL.HG = CN()
_C.MODEL.HG.INTERNAL_CHANNEL = 128
...
_C.MODEL.RPN.ANCHOR_STRIDE = (16,) #  (4, 8, 16, 32, 64)
...
_C.LOSS.INSTANCE = CN()
_C.LOSS.INSTANCE.K1 = 1.0
_C.LOSS.INSTANCE.ALPHA = 0.5
_C.LOSS.INSTANCE.BETA = 0.5
...
_C.DO_POST_PROC = True
_C.HARD_CASE_UPDATE_PERIOD = 500
