...
class DatasetCatalog(object):
    ...
    DATASETS = {       
        ...
        ##############################################
        "aicom_lane_train": {
            "img_dir": "lane_detection/images",
            "ann_dir": "lane_detection/trainset.json",
            "split": "train",
        },
        "aicom_lane_test": {
            "img_dir": "lane_detection/images",
            "ann_dir": "lane_detection/valset.json",
            "split": "val",
        }, 
        "aicom_lane_inference": {
            "img_dir": "lane_detection/test/images",
            "ann_dir": "",
            "split": "test",
        }, 
    }
    ...
    def get(name):
        ...
        elif "aicom_lane" in name:
            data_dir = DatasetCatalog.DATA_DIR
            attrs = deepcopy(DatasetCatalog.DATASETS[name])
            attrs["img_dir"] = os.path.join(data_dir, attrs["img_dir"])
            attrs["ann_dir"] = os.path.join(data_dir, attrs["ann_dir"])
            return dict(factory="LaneDetectionDataset", args=attrs)
